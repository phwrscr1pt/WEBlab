...
**เป้าหมาย:** เรียนรู้ SQL commands พื้นฐานโดยพิมพ์คำสั่งด้วยตัวเอง
...
Lab นี้**ไม่มี**ตัวอย่างคำสั่งให้คลิก นักเรียนต้องคิดและพิมพ์ SQL ด้วยตัวเอง โดยดูจาก schema ที่แสดง:
- **ตาราง:** `playground_products`
...
หน้า `/lab06?id=1` เป็นหน้าหมวดหมู่สินค้าที่มีปุ่ม "เพิ่มลงตะกร้า" ทำงานได้จริง (local cart) เพื่อความสมจริง แต่จุดประสงค์หลักคือทดสอบ SQLi ที่ parameter `?id=`
...
- Lab 06: ระบุว่าปุ่มตะกร้าทำงานได้ (local cart)
